...
use Drupal\ffw_custom\Entity\office;


/**
 * Provides dynamic permissions for Office of different types.
 *
 * @ingroup ffw_custom
 *
 */
class officePermissions{
   ...
   *
   * @return array
   *   The office by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (office::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\ffw_custom\Entity\office $type
   *   The office type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(office $type) {
    $type_id = $type->id();
